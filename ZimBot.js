...
🔗 *𝗠𝗘𝗗𝗜𝗔 𝗨𝗥𝗟* : ${images}`,
                                                                                                ...
                                                                                                break
                                                                                                case 'play': case 'yt': case 'song': case 'video': {
...
📁 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 : ${anu.description}
                                                                                        ...
                                                                                        message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
                                                                                                            ...
                                                                                                            templateMessage: {
                                                                                                                hydratedTemplate: {
                                                                                                                    ...
                                                                                                                    hydratedButtons: [{
                                                                                                                        ...
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: 'SONG 128',
                                                                                                                            id: `ytmp3 ${anu.url} 128kbs`
                                                                                                                            }
                                                                                                                        },  {
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: 'SONG',
                                                                                                    ...
                                                                                                    break
                                                                                                case '2play': case '2yt': case '2song': case '2video': {
                                                                                                        if (!text) throw `Example : ${prefix + command} bts boy with luv`
                                                                                                        let yts = require("yt-search")
                                                                                                        let search = await yts(text)
                                                                                                        for (let i of search.all)                                                                                   
...
╱╱╱╱╱ TEST ╱╱╱╱╱╱╱╱
                                                                                        ...
                                                                                        message = await prepareWAMessageMedia({ image : { url: search.all[0].thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
                                                                                                            ...
                                                                                                            templateMessage: {
                                                                                                                hydratedTemplate: {
                                                                                                                    ...
                                                                                                                    hydratedButtons: [{
                                                                                                                        ...
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: '2 SONG DOCUMENT',
                                                                                                                            id: `ytmp3 ${search.all[0].url} 128kbs`
                                                                                                                            }
                                                                                                                        },  {
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: '2 SONG AUDIO',
                                                                                                    ...
                                                                                                    break   
                                                                                                    case '3play': case '3yt': case '3song': case '3video': {
                                                                                                        if (!text) throw `Example : ${prefix + command} bts boy with luv`
                                                                                                        let yts = require("yt-search")
                                                                                                        let search = await yts(text)
                                                                                                        let nima = search.all                                                                                 
...
`,
                                                                                                                    hydratedButtons: [{
                                                                                                                        ...
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: '3 SONG DOCUMENT',
                                                                                                                            id: `ytmp3 ${nima[0].url} 128kbs`
                                                                                                                            }
                                                                                                                        },  {
                                                                                                                        quickReplyButton: {
                                                                                                                            displayText: '3  SONG AUDIO',
                                                                                                                            id: `audytmp3 ${nima[0].url} 256kbs`
                                                                                                                            }
                                                                                                                        }, {quickReplyButton: {
                                                                                                                            displayText: '3  VIDEO',
