...
╰───────────────◎` ,
                                                                                                                    ...
                                                                                                                    hydratedButtons: [{
                                                                                                                        ...
                                                                                                                        quickReplyButton: {
                                                                                                                            ...
                                                                                                                            id: `docvideo ${search.all[1].url} 360p`
                                                                                                                            }
...
✥ URL : ${text}`
                                                                                        let buttonsVideoD = [
                                                                                          {buttonId: `docvideo ${text}`, buttonText: {displayText: '📁 Document Video'}, type: 1},
                                                                                          {buttonId: `ytvideoo ${text}`, buttonText: {displayText: '🎬 Video'}, type: 1}
                                                                                        ]
                                                                                        
                                                                                                    let buttonMessageVote = {
                                                                                                        text: teks_vote,
                                                                                                        footer: '📍 ᴅᴀʀᴋ ᴍᴀᴋᴇʀ ᴇᴅɪᴛɪᴏɴ🥷' ,
                                                                                                        buttons: buttonsVideoD,
                                                                                                        headerType: 1
                                                                                                    }
                                                                                                    ZimBotInc.sendMessage(m.chat, buttonMessageVote)
                                                                                                }
